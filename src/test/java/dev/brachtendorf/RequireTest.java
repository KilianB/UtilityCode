...
class RequireTest {
	...
	class RequireExact {
		...
		class Integer {
			...
			@Test
			void testMinimal() {
				assertEquals(java.lang.Integer.MIN_VALUE,
						(int) Require.exact(java.lang.Integer.MIN_VALUE, java.lang.Integer.MIN_VALUE));
			}

			@Test
			void testMaximal() {
				assertEquals(java.lang.Integer.MAX_VALUE,
						(int) Require.exact(java.lang.Integer.MAX_VALUE, java.lang.Integer.MAX_VALUE));
			}
		...
		class Double {
			...
			void testMinimal() {
				assertEquals(-java.lang.Double.MAX_VALUE,
						(double) Require.exact(-java.lang.Double.MAX_VALUE, -java.lang.Double.MAX_VALUE));
			}
	...
	class NonNull {
		...
		@Test
		void valid() {
			Integer[] intArr = new Integer[] { Integer.valueOf(1), Integer.MAX_VALUE, Integer.MIN_VALUE };
			Require.nonNull(intArr, "");
		}
		...
		class Double {
			...
			void testPositiveInfinity() {
				assertEquals(java.lang.Double.POSITIVE_INFINITY,
						(double) Require.oddValue(java.lang.Double.POSITIVE_INFINITY));
			}
